...
$db=mysqli_connect(DB_SERVER, DB_USER, DB_PASS, DB_NAME);
	$sql = "SELECT Login,userlevel,e_pastas,id_Kontora "
...
<html>
    ...
    <tr><td><b>Vartotojo vardas</b></td><td><b>Buvusi rolė</b></td><td><b>Nauja rolė</b></td><td><b>Buvusi kontora</b></td><td><b>Nauja kontora</b></td></tr>
<?php
	...
	{	 
		...
		$nKontora= $_POST['id_Kontora_'.$user];
		$nlevel=$_POST['role_'.$user];
		$naikinti=(isset($_POST['naikinti_'.$user]));
		if ($naikinti || ($nlevel != $level) || ($nKontora != $Kontora)) 
...
// pakeitimus irasysim i sesija 
   ...
   $_SESSION['ka_keisti']=$keisti; $_SESSION['pakeitimai']=$pakeitimai; $_SESSION['pakeitimai2']=$pakeitimai2;
?>
	  </table>
    </form>
  </body></html>
