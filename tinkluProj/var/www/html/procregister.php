...
$Telefono_nr=$_POST['Telefono_nr'];$_SESSION['Telefono_nr_login']=$Telefono_nr;
  ...
  $_SESSION['prev'] = "procregister";
		...
		{ // vardas  geras,  nuskaityti vartotoja is DB
		 ...
		 if ($_SESSION['ulevel'] == $user_roles[ADMIN_LEVEL] ){
			 ...
			 $ukontora=$_POST['id_Kontora'];  // jei registravo adminas, imam jo nurodyta role
		 }
		 else 
		 {
		 ...
		 $db=mysqli_connect(DB_SERVER, DB_USER, DB_PASS, DB_NAME);
				if($ukontora == "NULL"){
		 $sql = "INSERT INTO " . TBL_SPECIALISTAS. " (Vardas, Pavarde, Telefono_nr, e_pastas, Login, Password, userlevel, id, id_Kontora)
          VALUES ('$Vardas','$Pavarde','$Telefono_nr','$mail','$user', '$pass', '$ulevel','$userid', NULL )";
				}
				else
				{
					$sql = "INSERT INTO " . TBL_SPECIALISTAS. " (Vardas, Pavarde, Telefono_nr, e_pastas, Login, Password, userlevel, id, id_Kontora)
          VALUES ('$Vardas','$Pavarde','$Telefono_nr','$mail','$user', '$pass', '$ulevel','$userid', $ukontora )";
				}
